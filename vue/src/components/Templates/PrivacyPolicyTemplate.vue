<template>
    <div class="privacy-container">
        <h1>Privacy Policy for Ipito</h1>

        <p>
            At Ipito, accessible from https://ipito.surf, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by Ipito and how we use it.
        </p>
        ...
        <p>
            Ipito follows a standard procedure of using log files. These files
        ...
        <p>
            Like any other website, Ipito uses 'cookies'. These cookies are used
        ...
        <p
            ...
            the advertising partners of Ipito.</p
        >

        <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Ipito, which are
        ...
        <p>
            Note that Ipito has no access to or control over these cookies that
        ...
        <p>
            Ipito's Privacy Policy does not apply to other advertisers or
        ...
        <p>
            Ipito does not knowingly collect any Personal Identifiable
        ...
        <p>
            ...
            that they shared and/or collect in Ipito. This policy is not
